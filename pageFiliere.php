...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="about.php" class="nav-item nav-link">Admission</a>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Etablissement</a>
                <div class="dropdown-menu fade-down m-0">
                    <a href="pageFiliere.php" class="dropdown-item">Faculter des sciences et de la technologie</a>
                    <a href="#" class="dropdown-item">faculter des sciences de la sabte</a>
                    <a href="#" class="dropdown-item">iea</a>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Filiere</h1>
